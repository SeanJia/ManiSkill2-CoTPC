...
@register_env("PegInsertionSide-v1", max_episode_steps=None)
class PegInsertionSideSim2RealEnv(StationaryManipulationEnv):
    ...
    def _load_actors(self):
        ...
        # box with hole
        inner_radius, outer_radius, depth = 0.035, length, length
        self.box = self._build_box_with_hole(inner_radius, outer_radius, depth)
        self.box_hole_offset = Pose(np.hstack([0, [0, 0]]))
        self.box_hole_radius = inner_radius
