...
from mani_skill2.utils.sapien_utils import check_actor_static, vectorize_pose, get_entity_by_name

from .base_env import StationaryManipulationEnv

from mani_skill2.agents.robots.xarm import Xarm
...
class StackCubeEnv(StationaryManipulationEnv):
    ...
    def _load_actors(self):
        ...
        self.cubeA = self._build_cube(self.box_half_size, color=(1, 1, 0), name="cubeA")
        self.cubeB = self._build_cube(
            self.box_half_size, color=(0, 1, 0), name="cubeB", static=False
        )
